...
class OtherUserProfile(Validator):
...
# this class is use for edit profile validation
class OtherUserPosts(Validator):
    user_id = 'required|numberic'
    ...
    message = {
        ...
        'page_limit': {
            'required': Messages.IS_REQUIRED.format(field_name="page_limit"),
            'numberic': Messages.SHOULD_BE_NUMERIC.format(field_name="page_limit")
        }
    }
